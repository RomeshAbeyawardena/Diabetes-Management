...
<template>
    <div id="navigation" class="grid justify-content-center align-items-center">
        <div class="col-2">
            <Button icon="pi pi-angle-double-left" :disabled="blockEvents" @click="setDateFilter('subtract')"
        ...
        <div class="col-2">
            <Button icon="pi pi-angle-double-right" :disabled="blockEvents" @click="setDateFilter('add')"
                    class="p-button-rounded p-button-outlined" /> 
        </div>
    </div>
</template>